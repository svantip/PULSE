...
Handles fine-tuning of emotion classification models with versioning support.
"""
import os
import json
...
class EmotionClassifier:
    """
    Emotion classifier with fine-tuning capabilities and MLflow versioning.
    """
    ...
    def fine_tune(self, train_dataset, eval_dataset, output_dir: str = None):
        ...
        Args:
            ...
            output_dir: Directory to save fine-tuned model (if None, uses default from config or './emotion_models')
        """
        ...
        try:
            ...
            if mlflow_enabled:
                ...
                mlflow.log_param("num_labels", len(self.emotion_labels))
            ...
            if mlflow_enabled:
                mlflow.transformers.log_model(self.model, "emotion_model")
    ...
    def compare_models(self, train_dataset, eval_dataset, output_dir: str = None) -> Dict[str, Any]:
        ...
        Args:
            train_dataset: Training dataset
            eval_dataset: Evaluation dataset
            output_dir: Directory to save models (if None, uses default './emotion_models')
        ...
        print(f"\n{'='*60}")
        print(f"Comparing {len(models_config)} models for emotion classification")
        print(f"{'='*60}\n")
