...
class EmotionClassifier:
    ...
    def fine_tune(self, train_dataset, eval_dataset, output_dir: str = "./emotion_models"):
        """
        ...
        with mlflow.start_run(run_name=f"emotion_finetune_{datetime.now().strftime('%Y%m%d_%H%M%S')}"):
